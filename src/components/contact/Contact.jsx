...
const Contact = () => {
  ...
  const notify = () => {
    error && toast.error('Email was not sent !', {
    position: "top-right",
    autoClose: 5000,
    ...
    success && toast.success('Email sent successfully !', {
      position: "top-right",
      autoClose: 5000,
      hideProgressBar: false,
      closeOnClick: true,
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_h3bjij7', 'template_6ljeq8f', formRef.current, {
        publicKey: '8N_1Q5m2OQafTEet8',
      })
      .then(
        () => {
          setSuccess(true);
    ...
    <motion.div className='contact' variants={variants} initial="initial" whileInView="animate">
        <motion.div variants={variants} className="textContainer">
          ...
          <motion.div className="item" variants={variants}>
            <h2>Mail</h2>
            <span>gurjidze.buba@gmail.com</span>
          </motion.div>
          ...
          <div className="item" variants={variants}>
            <h2>Mobile Number</h2>
            <span>+995 574 731 792</span>
          </div>
        </motion.div>
        <div className="formContainer">
          <motion.div className="phoneSvg" initial={{opacity: 1}} whileInView={{opacity: 0}} transition={{delay: 3, duration: 1}}>
          <svg fill="#FFA500" width="500px" height="500px" viewBox="0 0 64 64" version="1.1" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
           <motion.path
